'''
Current clamp demo using Allen Brain's model 473561729.
...
from neuron473561729 import Neuron473561729
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473561729(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473561729; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-90.7373962402)
        h.fcurrent()
